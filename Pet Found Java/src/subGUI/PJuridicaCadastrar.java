...
public class PJuridicaCadastrar extends javax.swing.JFrame {
    ...
    public PJuridicaCadastrar(String admin, String au) {
        initComponents();
        setIcon();
        adm = admin;
        audio = au;
    ...
    public static String generatePJCode(String nick, String name) {
    ...
    public void cadastro() {
        ...
        if (perm == false) {
            String cnpj = formatcnpj(textf_cnpj.getText());
                    ...
                    if (rs.next()) {
                        ...
                        if (rs.next()) {
                            ...
                            if (rs.next()) {
                                ...
                                ps = connection.prepareStatement("select * from juridica where cnpj=?;");
                                ps.setString(1, cnpj);
                                rs = ps.executeQuery();
                                if (rs.next()) {
                                    alert al = new alert(adm, audio);
                                    al.setVisible(true);
                                    String msg = "CPNJ de Pessoa Jurídica";
                                    String msg2 = "já existe";
                                    String tit = "Pessoa Jurídica existente";
                                    al.alertinput(tit, "erro", msg, msg2, "", "erro");

                                } else {
                                    // fazendo a validação dos dados
                                    if ((textf_nome.getText().isEmpty()) || (textf_uf.getText().isEmpty()) || (textf_contato.getText().equals("(  )     -    ")) || (textf_email.getText().isEmpty()) || (pass_senha.getText().isEmpty()) || (pass_senhaconfirm.getText().isEmpty()) || (textf_ende.getText().isEmpty()) || (textf_nick.getText().isEmpty()) || (textf_cnpj.getText().equals("  .   .   /0001-  ")) || (textf_ramativ.getText().isEmpty()) || (comb_tp.getSelectedItem() == null) || (textf_bai.getText().isEmpty()) || (textf_uf.getText().isEmpty()) || (textf_ende.getText().isEmpty()) || (textf_num.getText().isEmpty()) || (textf_cid.getText().isEmpty()) || (textf_cep.getText().equals("     -   "))) {
                                        alert al = new alert(adm, audio);
                                        al.setVisible(true);
                                        ...
                                        String pjCode = generatePJCode(nick, nome);
                                        if (!email.matches("^[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$")) {
                                            alert al = new alert(adm, audio);
                                            al.setVisible(true);
                                            String msg = "Endereço de e-mail";
                                            String msg2 = "inválido";
                                                        ...
                                                        if (matcher2.matches()) {
                                                            ...
                                                            if (matcher3.matches()) {
                                                                ...
                                                                if (matcher4.matches()) {
                                                                    ...
                                                                    hr = HrAtual();
                                                                    // O tipo é válido
                                                                    PJuridicaMOD pj = new PJuridicaMOD();

                                                                    pj.setCodp(pjCode);
                                                                    pj.setNomep(textf_nome.getText());
                                                                    pj.setContatop(formatcont(textf_contato.getText()));
                                                                    pj.setEmailp(textf_email.getText());
                                                                    pj.setSenha(pass_senha.getText());
                                                                    pj.setNickname(textf_nick.getText());
                                                                    pj.setEnderecop(textf_ende.getText());
                                                                    pj.setCnpj(formatcnpj(textf_cnpj.getText()));
                                                                    pj.setRamoativ(textf_ramativ.getText());
                                                                    pj.setTipo((String) comb_tp.getSelectedItem());
                                                                    pj.setImg(fis);
                                                                    pj.setTamanho(tamanho);
                                                                    pj.setHrcriacao(hr);
                                                                    pj.setDtcriacao(date);
                                                                    pj.setCep(cep);
                                                                    pj.setNum(num);
                                                                    pj.setBai(textf_bai.getText());
                                                                    pj.setCmpt(textf_cmp.getText());
                                                                    pj.setEnd(textf_ende.getText());
                                                                    pj.setUf(uf);
                                                                    pj.setCodend(generateEndCode(textf_nome.getText(), pjCode));
                                                                    pj.setCid(textf_cid.getText());
                                                                    ...
                                                                    if (pass_senha.getText().equals(pass_senhaconfirm.getText())) {
                                                                        ...
                                                                        alert al = new alert(adm, audio);
                                                                        al.setVisible(true);
                                                                        String msg = "Pessoa Jurídica " + textf_nome.getText();
                                                                        String msg2 = "inserido(a) com sucesso!";
                                                                        String tit = "Cadastro de Pessoa Jurídica";
    ...
    private void initComponents() {
        ...
        textf_cnpj = new javax.swing.JFormattedTextField();
        ...
        setTitle("Pet Found - Cadastrar Pessoa Jurídica");
        ...
        Plogin.setPreferredSize(new java.awt.Dimension(720, 446));
        ...
        textf_cnpj.setBackground(new java.awt.Color(255, 253, 243));
        textf_cnpj.setBorder(null);
        try {
            textf_cnpj.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##.###.###/0001-##")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        textf_cnpj.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        textf_cnpj.setPreferredSize(new java.awt.Dimension(200, 20));
        textf_cnpj.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                textf_cnpjKeyPressed(evt);
            }
        });
                ...
                .addGroup(PloginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PloginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(PloginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(textf_cnpj, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(label_foto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        getContentPane().add(PFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1041, -1));
...
//            PJuridica pj = new PJuridica(adm, audio);
    ...
    private void textf_cnpjKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textf_cnpjKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            cadastro();
        }
    }//GEN-LAST:event_textf_cnpjKeyPressed

    private void RatvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RatvaActionPerformed
        Mixer.Info[] mixers = AudioSystem.getMixerInfo();

        if (mixers.length == 0) {
            String nick = label_nick.getText();
            alert al = new alert(adm, audio);
            al.setVisible(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String ad = "";
                String au = "off";
                new PJuridicaCadastrar(ad, au).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField textf_cnpj;
