...
public class ServicoReprovar extends javax.swing.JFrame {

    private Connection connection;
    String adm, audio, pet, codadm;

    public ServicoReprovar(String adm, String aud, String pet) {
        this.adm = adm;
        audio = aud;
        this.pet = pet;
        initComponents();
    ...
    public void enviar() {
        ...
        String status = "";
        try {
            ps = connection.prepareStatement("update servico set aprovacaoserv=? ,admin_codadmn=?,motivorepserv=? where servcod=?");
    ...
    private void initComponents() {
        ...
        setTitle("Pet Found - Reprovar Serviço");
    ...
    private void btn_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastrarActionPerformed
        audios("aviso");
        int escolha = JOptionPane.showConfirmDialog(null, "Deseja Mesmo Reprovar O Serviço?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServicoReprovar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                String au = "";
                String pet = "";
                new ServicoReprovar(adm, au, pet).setVisible(true);
            }
        });
    }
