...
import subGUI.PetAtualizar;
import subGUI.PetCadastrar;
import subGUI.PetReprovar;

public class PetBuscar extends javax.swing.JInternalFrame {
    ...
    public PetBuscar(String adm, String au, String p) {
        initComponents();
        ...
        jTable1.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (jTable1.getValueAt(jTable1.getSelectedRow(), 14) == null) {
                    apv = null;
                } else {
                    apv = "achou";
                }
                selcod = jTable1.getValueAt(row, 8).toString();
                setImg(selcod);
                Buscaatt(selcod);
                busdst(selcod);
                if (selcod != null) {
    ...
    public void busdst(String user) {
        ...
        try {
            ...
            if (res.next()) {
                Boolean tx5 = res.getBoolean(20);//bloq
                if (tx5) {
                    btn_dst.setIcon(new ImageIcon(PetBuscar.class.getResource("/img/icon_atv.png")));
                    dst = false;
                } else {
                    btn_dst.setIcon(new ImageIcon(PetBuscar.class.getResource("/img/icon_dest.png")));
                    dst = true;
                }
    ...
    public void limfiltro() {
        ...
        cb_dst.setSelectedItem("Todos os Tipos de Pets At/Dst");
        cb_faixa.setSelectedItem("Todas as Faixas-Etárias");
        cb_final.setSelectedItem("Todos os Tipos de Anuncios");
        cb_ordem.setSelectedItem("Mais Recentes");
        cb_sx.setSelectedItem("Todos os Sexos");
        cb_porte.setSelectedItem("Todos os Portes");
    ...
    public void delet(String cod) {
        ...
        try {
            ...
            ps = connection.prepareStatement("DELETE FROM contatopet WHERE petcodpet =?;");
            ps.setString(1, cod);
            ...
            ps = connection.prepareStatement("DELETE FROM pet WHERE petcod = ?;");
            ps.setString(1, cod);
            i = ps.executeUpdate();
            ...
            if (i != 0) {
                ...
                al.setVisible(true);
                String msg = "Pet " + selcod;
                String msg2 = "deletado do database";
                String tit = "Deleção de Pet";
                ...
                try {
                    ...
                    switch (selectedOption) {
                        ...
                        case "Código de Pessoa":
                            ps = connection.prepareStatement("select * from pet where pessoacodp=?;");
                            break;
                        default:
                            ps = connection.prepareStatement("select * from pet where admincodadmn=?;");
                            break;
                    }
            ...
            case 4: {
                ...
                try {
                    ...
                    if (!rs.next()) {
                        alert al = new alert(admin, audio);
                        al.setVisible(true);
                        String msg = "ID do Pet não existe";
                        String tit = "Pet inexistente";
                        al.alertinput(tit, "erro", "", msg, "", "erro");
    ...
    public void setImg(String user) {
        this.connection = new ConnectionFactory().getConnection();
        String sql = "SELECT * FROM imagem WHERE petcodpet = ?";
        try {
            PreparedStatement stm = connection.prepareStatement(sql);
            stm.setString(1, user);
            ResultSet res = stm.executeQuery();
    ...
    public void buscarpettdesp(String user) {
        ...
        if ("Mais Recentes".equals(selectedOption)) {
            ord = "ORDER BY pet.dtp ASC, pet.hrp ASC;";
        } else {
            ord = "ORDER BY pet.dtp DESC, pet.hrp DESC;";
        }
        ...
        if (null == selectedOption) {
            ...
            switch (selectedOption) {
                case "Pets Desativados":
                    bloq = " and bloqueiopet=true";
                    break;
                case "Pets Ativos":
                    bloq = " and (bloqueiopet IS NULL OR bloqueiopet = False)";
                    break;
                default:
                    bloq = "";
                    break;
        ...
        switch (selectedOption) {
            case "Anuncio Aprovado":
                anunc = " and aprovacaopet = true";
                break;
            case "Anuncio Reprovado":
                anunc = " and aprovacaopet = false";
                break;
            case "Todos Tipos de Aprovações":
                anunc = "";
                break;
            default:
                anunc = " and aprovacaopet IS NULL";
                break;
        }

        selectedOption = (String) cb_porte.getSelectedItem();
        String porte;
        if (selectedOption == "Todos os Portes") {
            porte = "";
        } else {
            porte = " and porte=" + selectedOption;
        }

        selectedOption = (String) cb_faixa.getSelectedItem();
        String faixa;
        if (selectedOption == "Todas as Faixas-Etárias") {
            faixa = "";
        } else {
            faixa = " and fai_ida=" + selectedOption;
        }

        selectedOption = (String) cb_final.getSelectedItem();
        String finali;
        if (selectedOption == "Todos os Tipos de Anuncios") {
            finali = "";
        } else {
            finali = " and finalidade=" + selectedOption;
        }

        String sx;
        selectedOption = (String) cb_sx.getSelectedItem();
        if (selectedOption == "Todos os Sexos") {
            sx = "";
        } else {
        ...
        switch (tipo2) {
            ...
            case 1: {
                String sql = "SELECT * FROM pet where pessoacodp= '" + user + "'" + bloq + anunc + sx + porte + faixa + finali + " " + ord;
                try {
                    PreparedStatement stm = connection.prepareStatement(sql);
                    ...
                    if (result) {
                        while (result) {
                            ...
                            row[1] = res.getString(5);
                            row[2] = res.getString(8);
                            row[3] = res.getString(6);
                            row[4] = res.getString(7);
                            row[5] = res.getString(4);
                            row[6] = res.getString(3);
                            row[7] = res.getString(2);
                            row[8] = res.getString(9);
                            row[9] = res.getString(12);
                            row[10] = res.getString(13);
                            row[11] = res.getString(14);
                            row[12] = res.getString(11);
                            row[13] = res.getString(10);
                            row[14] = res.getString(15);
                            row[15] = res.getString(16);
                            row[16] = res.getString(17);
                            row[17] = res.getString(18);
                            data.add(row);
                            result = res.next();
                        }
                    } else if (pf != null) {
                        alert al = new alert(admin, audio);
                        al.setVisible(true);
                        String msg = "Nenhum Pet foi Encontrado";
                        String msg2 = "Com essa pessoa";
                        String tit = "Buscar Pets";
                        al.alertinput(tit, "erro", msg, msg2, "", "erro");
                        al.setAlwaysOnTop(true);
                    }
                    // Define os nomes das colunas
                    Object[] columnNames = {"Nome", "Raça", "Porte", "Cor da pelagem", "Sexo", "Faixa-etária/idade", "História", "Descrição", "Código", "Estado", "Cidade", "Finalidade", "Cod de Adm", "Cod de User", "Aprovação do Pet", "Data de Criação", "Hora de Criação", "Tipo de Pet"};
            ...
            case 4: {
                String sql = "SELECT * FROM pet where admincodadmn= '" + user + "'" + bloq + anunc + sx + porte + faixa + finali + " " + ord;
                try {
                    PreparedStatement stm = connection.prepareStatement(sql);
                    //stm.setString(1, user ); // Define o valor do parâmetro com o operador %
                    ResultSet res = stm.executeQuery();
        ...
        if ("Pets Desativados".equals(selectedOption)) {
            btn_dst.setIcon(new ImageIcon(PetBuscar.class.getResource("/img/icon_atv.png")));
        } else {
    ...
    public void buscarPet(String user) {
        ...
        /* if (check_bloq.isSelected()) {
            bloq = "bloqueiopet=true";
        } else {
            bloq = "(bloqueiopet IS NULL OR bloqueiopet = False)";
        }*/
        ...
        switch (tipo2) {
            case 2:
                sql = "select * from pet where petcod= '" + user + "'" + bloq + anunc + sx + porte + faixa + finali;
                try {
                    PreparedStatement stm = connection.prepareStatement(sql);
                    ResultSet res = stm.executeQuery();

                    // Cria uma matriz bidimensional para armazenar os dados do SELECT
                    Object[][] tabelpet = new Object[1][18]; // Número de colunas é 4

                    while (res.next()) {
                        resul++;
                        tabelpet[0][0] = res.getString(1);
                        tabelpet[0][1] = res.getString(5);
                        tabelpet[0][2] = res.getString(8);
                        tabelpet[0][3] = res.getString(6);
                        tabelpet[0][4] = res.getString(7);
                        tabelpet[0][5] = res.getString(4);
                        tabelpet[0][6] = res.getString(3);
                        tabelpet[0][7] = res.getString(2);
                        tabelpet[0][8] = res.getString(9);
                        tabelpet[0][9] = res.getString(12);
                        tabelpet[0][10] = res.getString(13);
                        tabelpet[0][11] = res.getString(14);
                        tabelpet[0][12] = res.getString(11);
                        tabelpet[0][13] = res.getString(10);
                        tabelpet[0][14] = res.getString(15);
                        tabelpet[0][15] = res.getString(16);
                        tabelpet[0][16] = res.getString(17);
                        tabelpet[0][17] = res.getString(18);
                    }
                    ...
                    // Cria um modelo de tabela personalizado usando os dados e nomes das colunas
                    CustomTableModel model = new CustomTableModel(tabelpet, columnNames);
    ...
    public void BPersPet(String user) {
        ...
        switch (tipo2) {
            case 2: {
                String sql = "SELECT * FROM pet where petcod like ?" + bloq + anunc + sx + porte + faixa + finali + " " + ord;
                try {
                    PreparedStatement stm = connection.prepareStatement(sql);
                    stm.setString(1, user + "%"); // Define o valor do parâmetro com o operador %
                    ResultSet res = stm.executeQuery();
            ...
            case 1: {
                String sql = "SELECT * FROM pet where pessoacodp like ?" + bloq + anunc + sx + porte + faixa + finali + " " + ord;
                try {
                    PreparedStatement stm = connection.prepareStatement(sql);
                    stm.setString(1, user + "%"); // Define o valor do parâmetro com o operador %
                    ResultSet res = stm.executeQuery();
            ...
            case 3: {
                String sql = "SELECT * FROM pet where admincodadmn like ?" + bloq + anunc + sx + porte + faixa + finali + " " + ord;
                try {
                    PreparedStatement stm = connection.prepareStatement(sql);
                    stm.setString(1, user + "%"); // Define o valor do parâmetro com o operador %
                    ResultSet res = stm.executeQuery();
    ...
    public void buscarTodospet() {
        ...
        if (bloq == " WHERE") {
            switch (selectedOption) {
                case "Anuncio Aprovado":
                    anunc = " aprovacaopet = true";
                    break;
                case "Anuncio Reprovado":
                    anunc = " aprovacaopet = false";
                    break;
                case "Todos Tipos de Aprovações":
                    anunc = "";
                    break;
                default:
                    anunc = " aprovacaopet IS NULL";
                    break;
            }
        } else {
            switch (selectedOption) {
        ...
        String faixa;
        selectedOption = (String) cb_faixa.getSelectedItem();
        if (bloq == " WHERE" && anunc == "" && porte == "") {

            if (selectedOption == "Todas as Faixas-Etárias") {
                faixa = "";
            } else {
                faixa = " fai_ida='" + selectedOption + "'";
            }
        } else {
            if (selectedOption == "Todas as Faixas-Etárias") {
                faixa = "";
        ...
        String finali;
        selectedOption = (String) cb_final.getSelectedItem();
        if (bloq == " WHERE" && anunc == "" && porte == "" && faixa == "") {

            if (selectedOption == "Todos os Tipos de Anuncios") {
                finali = "";
            } else {
                finali = " finalidade='" + selectedOption + "'";
            }
        ...
        String sx;
        selectedOption = (String) cb_sx.getSelectedItem();
        if (bloq == " WHERE" && anunc == "" && porte == "" && faixa == "" && finali == "") {
        ...
        if (bloq == " WHERE" && (anunc == "" && porte == "" && faixa == "" && finali == "" && sx == "")) {
            bloq = "";
        }

        String sql = "SELECT * FROM pet" + bloq + anunc + porte + faixa + finali + sx + " " + ord;
        try {
            PreparedStatement stm = connection.prepareStatement(sql);
            ResultSet res = stm.executeQuery();
    ...
    public void atualizar(String Cod) {
        ...
        if ((admin == null) || (admin == "")) {
            ...
            String tit = "Detalhes Pet não atualizados";
            al.alertinput(tit, "erro", "", msg, "", "erro");
            ...
            if (radio_apv.isSelected()) {
                ...
                try {
                    ...
                    if (i != 0) {
                        ...
                        alert al = new alert(admin, audio);
                        al.setVisible(true);
                        String msg = "Detalhes Pet não atualizados";
                        String tit = "Atualização de Pet";
                        al.alertinput(tit, "erro", "", msg, "", "erro");
                    }
                } catch (SQLException e) {
                ...
                audios("tci");
                PetReprovar pr = new PetReprovar(admin, audio, Cod);
                pr.setVisible(true);
    ...
    private void initComponents() {
        ...
        cb_porte = new javax.swing.JComboBox<>();
        cb_faixa = new javax.swing.JComboBox<>();
        ...
        jbuttonArr1.setToolTipText("Enviar Análise de Aprovação de Pet");
        ...
        btn_cad.setToolTipText("Cadastrar Pet");
        ...
        btn_att.setToolTipText("Atualizar Pet Selecionado");
        ...
        textf_result.setToolTipText("Resultados Encontrados na Tabela de Pet");
        ...
        Cb_pet.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código de Pet", "Código de Pessoa", "Código de Admin Que Aprovou" }));
        ...
        btn_dst.setToolTipText("Desativar/Ativar o Pet Selecionado");
        ...
        btn_deletar.setToolTipText("Deletar o Pet Selecionado");
        ...
        cb_ordem.setToolTipText("Pets em Ordem de data Crescente/Decrescente");
        cb_ordem.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        cb_porte.setBackground(new java.awt.Color(255, 253, 243));
        cb_porte.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos os Portes", "Grande", "Medio", "Pequeno" }));
        cb_porte.setToolTipText("Porte de Pets");
        cb_porte.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cb_porte.setMinimumSize(new java.awt.Dimension(202, 22));
        cb_porte.setPreferredSize(new java.awt.Dimension(202, 22));

        cb_faixa.setBackground(new java.awt.Color(255, 253, 243));
        cb_faixa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todas as Faixas-Etárias", "Filhote", "Jovem", "Adulto", "Senior", "Idoso" }));
        cb_faixa.setToolTipText("Faixa-Etária de Pet");
        cb_faixa.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cb_faixa.setMinimumSize(new java.awt.Dimension(202, 22));
        cb_faixa.setPreferredSize(new java.awt.Dimension(202, 22));

        cb_final.setBackground(new java.awt.Color(255, 253, 243));
        cb_final.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos os Tipos de Anuncios", "Adocao", "Padrinho", "Pad_Ado" }));
        cb_final.setToolTipText("Pets Para Adoção/Padrinhamento");
        cb_final.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cb_final.setMinimumSize(new java.awt.Dimension(202, 22));
        cb_final.setPreferredSize(new java.awt.Dimension(202, 22));
        ...
        cb_anunc.setToolTipText("Pets Aprovados/Reprovados/Não Analisados");
        ...
        cb_dst.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos os Tipos de Pets At/Dst", "Pets Ativos", "Pets Desativados" }));
        ...
        cb_sx.setToolTipText("Sexo de Pets");
        ...
        btn_filpet.setText("Filtrar Pets");
        btn_filpet.setToolTipText("Procurar Pets com os filtros");
        ...
        textarea_mt.setToolTipText("Motivo que o Pet Reprovou");
        ...
        L_mt.setText("Motivo de Reprovar");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Raça", "Porte", "Cor da Pelagem", "Sexo", "Faixa-etária/idade", "História", "Descrição", "Código", "Estado", "Cidade", "Finalidade", "Cod de Adm", "Cod de User", "Aprovação do Pet", "Data de Criação", "Hora de Criação", "Tipo de Pet"
            }
        ) {
                ...
                .addGroup(PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PFundoLayout.createSequentialGroup()
                        ...
                        .addGroup(PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(cb_sx, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(PFundoLayout.createSequentialGroup()
                                    .addComponent(textf_copiado, javax.swing.GroupLayout.PREFERRED_SIZE, 596, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(label_copy)
                                    .addGap(12, 12, 12))
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, PFundoLayout.createSequentialGroup()
                                    .addGroup(PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(cb_porte, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(cb_ordem, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(cb_faixa, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(cb_anunc, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(cb_final, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(cb_dst, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(PFundoLayout.createSequentialGroup()
                        ...
                        .addGroup(PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(PFundoLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(cb_faixa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addGroup(PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(PFundoLayout.createSequentialGroup()
                        ...
                        .addGroup(PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(btn_cad, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(btn_deletar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(btn_dst, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(btn_att, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    public void bus() {
        ...
        if (!check_buperso.isSelected()) {
            ...
            if (selectedItem.equals("Código de Pet")) {
                tipo2 = 2;
                tipoveri = 2;
                String cod = textf_buscar.getText();
                verificar(cod);
                ...
                if ("null".equals(admin) || !"null".equals(selcod)) {
                    if (admin == null || admin.equals("")) {
                        ...
                        if (selcod == null || "".equals(selcod)) {
                            ...
                            audios("tc");
                            PetAtualizar adm = new PetAtualizar(admin, audio, selcod);
                            adm.setVisible(true);
                        }
                    }
                }
    ...
    public void cad() {
        ...
        if (admin == null || admin.equals("")) {
            ...
            audios("tc");
            PetCadastrar adm = new PetCadastrar(admin, audio);
            adm.setVisible(true);
        ...
        if (admin == null || admin.equals("")) {
            ...
            if (permchefe == true) {
                ...
                if (selcod == null) {
                    ...
                    audios("aviso");
                    int escolha = JOptionPane.showConfirmDialog(null, "Deseja Mesmo Deletar o Pet " + selcod + "?\nUma vez deletado, essas informações sumirão do banco de dados");
    ...
    public void dst() {
        if (admin == null || admin.equals("")) {
            ...
            if (selcod == null) {
                ...
                if (dst == false) {
                    audios("aviso");
                    int escolha = JOptionPane.showConfirmDialog(null, "Deseja Mesmo Ativar o Pet " + selcod + "?");
                    ...
                    audios("aviso");
                    int escolha = JOptionPane.showConfirmDialog(null, "Deseja Mesmo Desativar o Pet " + selcod + "?");
                    btn_dst.setIcon(new ImageIcon(PetBuscar.class.getResource("/img/icon_atv.png")));
                    if (escolha == 0) {
                        tipo2 = 4;
                        tipoveri = 4;
    ...
    private javax.swing.JComboBox<String> cb_faixa;
    private javax.swing.JComboBox<String> cb_final;
    private javax.swing.JComboBox<String> cb_ordem;
    private javax.swing.JComboBox<String> cb_porte;
