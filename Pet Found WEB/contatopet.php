...
<body>
    ...
    echo "<div class='popuppet'>
        <div class='cardp'>
            ...
            <h1>" . $cont . "</h1>
            <h3> Ao clicar em 'Criar Contato', você mostra interesse em ligar para o anunciante e permite o registro das ações do contato, podendo ser nomeado como padrinho ou tutor pelo dono temporário do pet.
            </h3>
            <br>
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($row = mysqli_fetch_assoc($result)) {
                    ...
                    window. history. back();
                        ...
                        $inicial_pf = substr($codpes, 0, 5);
                        $inicial_pet = substr($petcod, 0, 6);
                        $codcont = "CONT" . $inicial_pet . $hora_atual . $inicial_pf . $data_atual;
                        ...
                        if ($tip === "PF") {
                            ...
                            $sql = "INSERT INTO contatopet(pfcodp, petcodpet, tipocont, codcontp, dtcp, hrcp) 
                                VALUES('$pf','$petcod','$anunctf','$codcont','$data_atual2','$hora_atual2')";
                            ...
                            if (mysqli_query($mysqli, $sql)) {
                                ...
                                $mensagem = $_SESSION['usuario'] . " criou um contato com seu pet.";

                                $cod = "NOTCONTPET" . $cortecod . $hora_atual . $data_atual;
                        ...
                        window. history. back();
                            ...
                            if ($result2->num_rows > 0) {
                                ...
                                if ($tp === "Empresa") {
                                    ...
                                    $sql = "INSERT INTO contatopet(pfcodp, petcodpet, tipocont, codcontp, dtcp, hrcp) 
                                        VALUES('$pf','$petcod','apd','$codcont','$data_atual2','$hora_atual2')";
                                ...
                                echo "<script> Swal.fire(
                                        'Erro no Contato',
                                        'Você precisa ser um usuário do tipo Pessoa Física para entrar em contato.',
                                        'error'
                                    ).then(() => {
                                        window. history. back();
                                    });
