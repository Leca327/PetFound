...
<body bgcolor="#ff6600">
    ...
    if ($mysqli) {
        if (isset($_POST['snome']) && isset($_POST['nome']) && isset($_POST['email']) && isset($_POST['cont']) && isset($_POST['nik']) && isset($_POST['end']) && isset($_POST['cep']) && isset($_POST['uf']) && isset($_POST['cid']) && isset($_POST['num']) && isset($_POST['cpt']) && isset($_POST['end']) && isset($_POST['sexo']) && isset($_POST['dt'])) {
            ...
            if (strlen($nome) <= 50 && strlen($usuario) <= 50 && strlen($snome) <= 50 && strlen($email) <= 100 && strlen($end) <= 50 && strlen($brr) <= 25 && strlen($num) <= 5 && strlen($cpt) <= 25) {
                ...
                if ($total > 0) {
                    ...
                    if ($total > 0) {
                        ...
                        $sqlSelect = "SELECT * FROM pessoa p JOIN endereco e ON p.endcodend = e.endcod JOIN fisica f ON p.pcod = f.codp WHERE nickname = '$nikanti';";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            $sql1 = "UPDATE pessoa SET emailp = '$email', snomep='$snome',contatop = '$celular', nomep = '$nome', nickname='$usuario' WHERE 
        nickname = '$nikanti'";
                            $sql3 = "UPDATE fisica SET dt_nascimento = '$dt', sexo = '$sexo' WHERE codp = '$cod'";
